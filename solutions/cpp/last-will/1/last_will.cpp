...
namespace estate_executor{
    ...
    int assemble_code()
    {
        int blueZhang=zhang::blue::code_fragment();
        int blueKhan=khan::blue::code_fragment();
        int blueGarcia=garcia::blue::code_fragment();

        int redZhang=zhang::red::code_fragment();
        int redKhan=khan::red::code_fragment();
        int redGarcia=garcia::red::code_fragment();

        int sumBlue=blueZhang+blueKhan+blueGarcia;
        int sumRed=redZhang+redKhan+redGarcia;
